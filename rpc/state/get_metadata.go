...
func (s *State) GetMetadata(blockHash types.Hash) (string, error) {
	return s.getMetadata(&blockHash)
}

// GetMetadataLatest returns the latest metadata
func (s *State) GetMetadataLatest() (string, error) {
	return s.getMetadata(nil)
}

func (s *State) getMetadata(blockHash *types.Hash) (res string, err error) {
